...
var _appendStylesheetLink = _interopRequireDefault(require("coffeekraken-sugar/js/dom/appendStylesheetLink"));
  ...
  _createClass(Component, [{
    ...
    value: function componentWillMount() {
      ...
      if (this.props.loadCss) {
        (0, _appendStylesheetLink.default)('https://cdn.plyr.io/3.4.8/plyr.css');
      } // create a plyr


      this._plyr = new _plyr.default($holder, _objectSpread({}, this.props, {
        loop: {
